...
public:
    ...
    [[nodiscard]] bool IsHeroic() const { return IsRaid() ? i_spawnMode >= RAID_DIFFICULTY_10_25MAN_MYTHIC : i_spawnMode == DUNGEON_DIFFICULTY_HEROIC; }
    [[nodiscard]] bool IsMythic() const { return IsRaid() ? i_spawnMode >= RAID_DIFFICULTY_10_25MAN_MYTHIC : i_spawnMode == DUNGEON_DIFFICULTY_EPIC; }

...
enum AuraType
{
    ...
    SPELL_AURA_ALLOW_BLOCKING_SPELL                         = 164,
    ...
    SPELL_AURA_MOD_ARMOR_FROM_ATTACK_POWER                  = 299,
    SPELL_AURA_SHARE_DAMAGE_PCT                             = 300,
    SPELL_AURA_SCHOOL_HEAL_ABSORB                           = 301,
    SPELL_AURA_MOD_ATTAC_POWER_FROM_SPELL_POWER_PERCENT     = 302,

...
public:
    ...
    TempSummon* SummonCreatureGuardian(uint32 entry, Unit* target, Player* player, uint32 duration, float dist, float angle) const;
    ...
    [[nodiscard]] Creature* FindNearestCreatureWithoutEntry(ObjectGuid guid, float range, bool alive = true) const;

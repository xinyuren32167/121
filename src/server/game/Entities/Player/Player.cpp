...
void Player::RegenerateAll()
{
    ...
    if (m_regenTimerCount >= 2000)
    {
        ...
        if (getClass() == CLASS_DEATH_KNIGHT || getClass() == CLASS_DRUID || getClass() == CLASS_PRIEST || getClass() == CLASS_SHAMAN || getClass() == CLASS_WARLOCK)
...
void Player::Regenerate(Powers power)
{
    ...
    switch (power)
    {
        ...
        case POWER_RUNE:
        case POWER_FOCUS:
            addvalue += 0.01f * m_regenTimer * (sWorld->getRate(RATE_POWER_ENERGY) / 1.5);

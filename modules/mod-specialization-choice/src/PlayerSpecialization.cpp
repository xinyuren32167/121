...
void PlayerSpecialization::InitializeSpecializations()
{
    ...
    m_Specializations[PRIEST_DISCI] = { 29, 80536, "Discipline", 5, 900000, 25.93, true, 900001 };
    m_Specializations[PRIEST_HOLY] = { 30, 80549, "Holy", 5, 900005, 28.00, false, 0 };
    m_Specializations[PRIEST_SHADOW] = { 31, 53251, "Shadow", 5, 900008, 70.00, false, 0 };
}
